export const dom = {
  ...
  auditRoomFilterInput: document.querySelector("#audit-room-filter-input"),
  ...
  auditSummaryLine: document.querySelector("#audit-summary-line"),
  shoppingSummaryLine: document.querySelector("#shopping-summary-line"),
  auditConfirmVisibleButton: document.querySelector("#audit-confirm-visible-button"),
  ...
  auditEmptyState: document.querySelector("#audit-empty-state"),
